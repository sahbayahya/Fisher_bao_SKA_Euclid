...
if __name__=='__main__':
	...
	#z = ['z0', 'z1', 'z3', 'z5', 'z6', 'z7', 'z10', 'z23', 'z40', 'z70', 'z100'] 
	#b =['b0', 'b1', 'b3', 'b5', 'b6', 'b7', 'b10', 'b23', 'b40', 'b70', 'b100'] 
	#Srms= [0, 1, 3, 5, 6, 7.3, 10, 23,40, 70, 100] 
	...
	''' x range 
	'''
	xrange = [linspace(0, 2.5, 200),  linspace(0, 2.5, 200),  linspace(0, 2.5, 200),  linspace(0, 2.5, 200),  linspace(0, 2.5, 200),  linspace(0, 2., 200),  linspace(0, 0.8, 200), linspace(0, 0.6, 200), ]
	''' '--------------------------------------------------------------------------------------------------------------------------'
	...
	y_ = []
	for i in range(len(Srms)):
		y_.append(find_parameters(p0, np.array(z_[i]), np.array(b_[i]) , Srms[i], xrange[i]))
	
	'''plot using cmap
	'''
	y = y_ ; b= b_
	#tic = [ r'   $0 \mu$Jy',r'   $1 \mu$Jy', r'   $3 \mu$Jy', r'   $5 \mu$Jy',r'   $6 \mu$Jy',r'   $ 7.3 \mu$Jy' , \
	#'   $10 \mu$Jy' ,  r'   $23\mu$Jy', r'   $40 \mu$Jy' , r'   $70\mu$Jy'  ,r'   $100\mu$Jy' ] 
	...
	#colors = ['#700f2c', '#9f1128' ,'#b6495b' , '#e0765d',  '#fbdccf', '#fcd7c2', '#fbf2ec','#edf3f7',  '#c7e0ee',  '#96c7df', '#6faed2']
